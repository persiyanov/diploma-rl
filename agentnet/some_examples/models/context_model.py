...
class ConversationModelCTX(ConversationModel):
    ...
    def build_decoder_step(self,gru0_units=512,grad_clip=5,context_size=64):
        ...
        l_gru0 = GRUCell(l_prev_gru0,[prev_output_emb,context_vec],name='decoder gru0',grad_clipping=grad_clip)
        ...
        return [prev_output_word,context_vec],{l_gru0:l_prev_gru0},next_token_probas,next_token
    ...
    def build_decoder_objective(self,encoder_output,context_output,reference_answer,mask):
        ...
        (dec_prev_word,dec_context),dec_memory,dec_probas,dec_next_word = self.decoder_step
